...
sink("S:/etude25/2679_Danieli_These/Review/test_FF_nsim1000/lin_ph_lambda0.colon_0.02_2000/1000_patients/My_Test_FF_SigmaNum.lis")
...
chemin3    <- ("test_FF_nsim1000/lin_ph_lambda0.colon_0.02_2000/1000_patients/")
