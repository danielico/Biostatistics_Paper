...
sink("S:/etude25/2679_Danieli_These/Review/test_FF_nsim1000/nlin_ph_lambda0.colon_NLIN_Faible_1000/2000_patients/My_Test_FF_SigmaNum.lis")
...
chemin3    <- ("test_FF_nsim1000/nlin_ph_lambda0.colon_NLIN_Faible_1000/2000_patients/")
