...
sink("S:/etude25/2679_Danieli_These/Review/Test_PH_nsim1000/lin_nph_lambda0.colon_NPH_Faible_1000/1000_patients/My_Test_PH_SigmaNum.lis")
...
chemin3    <- ("Test_PH_nsim1000/lin_nph_lambda0.colon_NPH_Faible_1000/1000_patients/")
