...
sink("S:/etude25/2679_Danieli_These/Review/Additional_Results/alpha_PH_sc5/500_patients/My_Test_PH_SigmaNum.lis")
...
chemin3    <- ("Additional_Results/alpha_PH_sc5/500_patients/")
