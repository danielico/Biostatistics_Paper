...
sink("S:/etude25/2679_Danieli_These/Review/Additional_Results/alpha_PH_sc5/2000_patients/My_Test_PH_SigmaNum.lis")
...
chemin2    <- ("Simulations/nlin_ph_lambda0.colon_NLIN_Faible_1000/2000_patients/")
chemin3    <- ("Additional_Results/alpha_PH_sc5/2000_patients/")
