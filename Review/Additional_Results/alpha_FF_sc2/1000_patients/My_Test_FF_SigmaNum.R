# ------------------------------------------------------------------ #
# -- FF test : Fit LIN-PH model on LIN-NPH simulated data-- #
# ------------------------------------------------------------------ #
...
sink("S:/etude25/2679_Danieli_These/Review/Additional_Results/alpha_FF_sc2/1000_patients/My_Test_FF_SigmaNum.lis")
...
chemin.bis <- ("S:/etude25/2679_Danieli_These/Review/Additional_Results/alpha_FF_sc2/")
chemin2    <- ("Simulations/lin_nph_lambda0.colon_NPH_Faible_1000/1000_patients/")
chemin3    <- ("Additional_Results/alpha_FF_sc2/1000_patients/")
...
for ( Fich in 1:NbFichier )
{
  ...
  Covariables <- model.matrix(~-1+AGEC.DIAG.A,data=MyData) # Serait mieux si on pouvait directement extraire cela de la formule du modele...
