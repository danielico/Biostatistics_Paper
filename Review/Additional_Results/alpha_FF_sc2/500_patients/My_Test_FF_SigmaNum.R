...
sink("S:/etude25/2679_Danieli_These/Review/Additional_Results/alpha_FF_sc2/500_patients/My_Test_FF_SigmaNum.lis")
...
chemin3    <- ("Additional_Results/alpha_FF_sc2/500_patients/")
