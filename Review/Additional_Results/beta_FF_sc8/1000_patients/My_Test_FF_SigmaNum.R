...
sink("S:/etude25/2679_Danieli_These/Review/Additional_Results/beta_FF_sc8/1000_patients/My_Test_FF_SigmaNum.lis")
...
chemin3    <- ("Additional_Results/beta_FF_sc8/1000_patients/")
