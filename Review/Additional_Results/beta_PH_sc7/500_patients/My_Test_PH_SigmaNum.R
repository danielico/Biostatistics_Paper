...
sink("S:/etude25/2679_Danieli_These/Review/Additional_Results/beta_PH_sc7/500_patients/My_Test_PH_SigmaNum.lis")
...
chemin2    <- ("Simulations/lin_nph_lambda0.colon_NPH_Faible_1000/500_patients/")
chemin3    <- ("Additional_Results/beta_PH_sc7/500_patients/")
