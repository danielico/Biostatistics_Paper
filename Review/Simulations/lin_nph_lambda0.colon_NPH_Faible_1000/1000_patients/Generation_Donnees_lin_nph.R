# source("S:/etude35/3596_survie_1989_2013/analyse/espacewCD2/test/Generation_Donnees_lin_nph_test.txt", echo=T)
...
chemin2 <- c("Simulations/lin_nph_lambda0.colon_NPH_Faible_1000/1000_patients/")
