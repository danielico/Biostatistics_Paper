...
cDataDesign.PourDiffusion <- function ( n = 500 , beta , modele.simule , site , cens.admin = 2013 , temps.survie = c(1,3,5,10) , min.adiag = 1990 , max.adiag = 2010 )
 
{
  ...
  annee <- runif(n, min = min.adiag, max = max.adiag+1)
  ...
  survie.tay$agec = survie.tay$age.entier - 70
  ...
  return( list( tab5 = tab5 , tab2 = tab2 , survie.pop = survie.pop ) )
}