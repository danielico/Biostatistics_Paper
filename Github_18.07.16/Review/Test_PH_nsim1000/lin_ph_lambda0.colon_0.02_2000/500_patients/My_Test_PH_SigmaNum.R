...
sink("S:/etude25/2679_Danieli_These/Review/Test_PH_nsim1000/lin_ph_lambda0.colon_0.02_2000/500_patients/My_Test_PH_SigmaNum.lis")

chemin     <- ("S:/etude25/2679_Danieli_These/Review/")
chemin.bis <- ("S:/etude25/2679_Danieli_These/Review/Test_PH_nsim1000/")
chemin2    <- ("Simulations/lin_ph_lambda0.colon_0.02_2000/500_patients/")
chemin3    <- ("Test_PH_nsim1000/lin_ph_lambda0.colon_0.02_2000/500_patients/")
...
# -----> Graphes for one particular dataset (the graph in the folder is associated to Fich = 1)
