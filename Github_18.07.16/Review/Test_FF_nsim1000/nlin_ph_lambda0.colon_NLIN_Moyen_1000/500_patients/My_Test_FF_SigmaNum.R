...
sink("S:/etude25/2679_Danieli_These/Review/test_FF_nsim1000/nlin_ph_lambda0.colon_NLIN_Moyen_1000/500_patients/My_Test_FF_SigmaNum.lis")
...
chemin2    <- ("Simulations/nlin_ph_lambda0.colon_NLIN_Moyen_1000/500_patients/")
chemin3    <- ("test_FF_nsim1000/nlin_ph_lambda0.colon_NLIN_Moyen_1000/500_patients/")
